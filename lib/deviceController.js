...
return null;
    ...
    buildDeviceDetails(device, station, stationPath) {
        ...
        // ── Tab 1: Gerätinfo ──────────────────────────────────────────────────
        const infoItems = {
            _h1: {type: 'header', text: 'Gerät', size: 12, newLine: true},
            _d1: {type: 'divider', color: 'primary'},
            serial: {
                type: 'staticInfo',
                label: 'Seriennummer',
        ...
        // ── Tab 2: Status ─────────────────────────────────────────────────────
        const statusItems = {
            _h1: {type: 'header', text: 'Status', size: 12, newLine: true},
            _d1: {type: 'divider', color: 'primary'},
            online: {
        ...
        // ── Tab 3: Hardware ───────────────────────────────────────────────────
        const hardwareItems = {
            _h1: {type: 'header', text: 'Hardware', size: 12, newLine: true},
            _d1: {type: 'divider', color: 'primary'},
        };
        if (data.batInfo !== undefined) {
        ...
        if (Object.keys(measureItems).length > 0) {
            tabs._tab_measure = {
                ...
                label: 'Messwerte',
                items: {
                    _h1: {type: 'header', text: 'Messwerte', size: 12, newLine: true},
                    _d1: {type: 'divider', color: 'primary'},
                    ...measureItems,
                },
            };
